...
export const initialSiteSettings: SiteSettings = {
  ...
  foundedYear: "2010",
  heroHeading: "DETECTIVES OF SUPERNATURALS",
  heroSubheading: "Rise Above Fear",
  heroDescription: "Founded in 2010, Detectives of Supernaturals (DOS) is India's leading paranormal research organization. We bridge the gap between science and the unexplained through rigorous technical investigation and empirical evidence collection.",
  heroBgUrl: "/horror_background_wide.jpg",
  whoWeAreTitle: "WHO WE ARE",
  whoWeAreDescription: "Detectives of Supernaturals (DOS) is India's pioneer technical paranormal research collective, founded in 2010. Rather than sensationalism or superstition, DOS operates with empirical discipline — investigating unexplained experiences through evidence-based documentation and technical analysis.",
  whoWeArePoints: [
